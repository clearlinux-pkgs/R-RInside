...
Version  : 0.2.17
Release  : 38
URL      : https://cran.r-project.org/src/contrib/RInside_0.2.17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RInside_0.2.17.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648828661
